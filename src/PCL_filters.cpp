...
void passthrough_filter(const sensor_msgs::PointCloud2ConstPtr& input_cloud_msg);
void voxel_grid_filter(const sensor_msgs::PointCloud2ConstPtr& input_cloud_msg);
void outliner_removal_filter(const sensor_msgs::PointCloud2ConstPtr& input_cloud_msg);
...
void filter_callback(const sensor_msgs::PointCloud2ConstPtr& input_cloud_msg){
  //    passthrough_filter(input_cloud_msg);
  //    voxel_grid_filter(input_cloud_msg);
  //    outliner_removal_filter(input_cloud_msg);
